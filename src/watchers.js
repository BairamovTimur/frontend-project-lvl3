...
const handlePosts = (state, elements, posts, oldPosts) => {
...
const handleFeeds = (elements, feed, oldFeed) => {
  ...
  const watchedState = onChange(state, (path, value, previousValue) => {
    switch (path) {
      ...
      case 'loadingProcess.status':
        ...
        break;
      case 'feeds':
        handleFeeds(elements, value, previousValue);
        break;
      case 'posts':
        handlePosts(state, elements, value, previousValue);
        break;
      default:
        break;
    }
